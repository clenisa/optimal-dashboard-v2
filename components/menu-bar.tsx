...
export function MenuBar() {
  ...
  return (
    <div
      ref={menuRef}
      className="fixed top-0 left-0 right-0 h-7 bg-white border-b border-black flex items-center justify-between px-2 text-xs font-bold z-50"
    ...
    >
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative">
          ...
          {activeMenu === "apple" && (
            <div className="absolute top-full left-0 mt-1 bg-white border border-black shadow-lg min-w-48 z-50">
              <button
